      ...
      >
        <div className="mx-auto hidden md:flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2 cursor-pointer">
            <button onClick={toggleTheme} className="cursor-pointer px-2.5 py-1.5 rounded-md dark:bg-gray-800 bg-gray-100/50  hover:text-indigo-400 transition-colors ease-linear duration-150">
              {theme === "dark" ? <Sun /> : <Moon />}
            </button>
            <NavLink
              to="signin"
