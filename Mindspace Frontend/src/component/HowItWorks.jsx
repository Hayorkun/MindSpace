        ...
        <div className="relative p-5 max-w-3xl flex flex-col gap-10">
          ...
          {howItWorks.map((h, i) => (
            <div key={i} className="flex justify-between gap-5">
              <div className="w-17 h-17 shrink-0 rounded-2xl border dark:border-gray-500 border-gray-300 dark:bg-gray-900 bg-gray-300/50 flex justify-center items-center">
