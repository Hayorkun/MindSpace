          ...
          <div className="flex flex-col gap-3 md:flex-row">
            <div className="md:flex-3 mb-5">
              ...
              <div className="w-fit md:w-40 flex  md:flex-col gap-3 mb-4">
                <NavLink to="/signup" className="flex justify-center px-4 py-2 text-xs gap-1 rounded-lg bg-indigo-500 text-white hover:bg-indigo-600 transition-colors ease-in-out duration-200">
                  Start for free <ArrowRight className="size-4" />
                </NavLink>
                <NavLink to="/login" className="border justify-center border-gray-400/30 flex text-xs px-4 py-2 rounded-lg hover:bg-gray-300/20 dark:hover:bg-gray-700/40 transition-colors ease-in-out duration-200">
                  See how it works
                </NavLink>
              </div>
