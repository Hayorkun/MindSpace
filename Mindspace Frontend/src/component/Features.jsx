        ...
        <div className="mt-10 grid gap-10 grid-flow-row md:grid-cols-3">
          {feature.map((f, index) => {
            ...
            return (
              <div
                key={index}
                className="p-7 border border-gray-400/60 rounded-xl hover:border-indigo-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-200 ease-in-out"
              >
